...
dotenv.config();
const generateJazzCashPayload = (amount) => {
    const { JAZZCASH_MERCHANT_ID, JAZZCASH_PASSWORD, JAZZCASH_INTEGRITY_SALT, JAZZCASH_RETURN_URL, JAZZCASH_POST_URL, } = process.env;
    const date = new Date();
...
export const jazzCashPayment = TryCatch(async (req, res, next) => {
